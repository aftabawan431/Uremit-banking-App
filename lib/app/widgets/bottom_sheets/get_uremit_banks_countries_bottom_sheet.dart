                            ...
                            : ListView.separated(
                                ...
                                itemBuilder: (_, index) {
                                  return ListTile(
                                    ...
                                    onTap: () {
                                      Logger().v(context.read<ReceiverInfoViewModel>().countriesList?.Body[index].countryName);

                                     if(context.read<ReceiverInfoViewModel>().countriesList?.Body[index].countryName=='Nepal'){
                                       context.read<ReceiverInfoViewModel>().isNepaliBank.value=true;
                                       Logger().v("this");
                                     }else{
                                       Logger().v("this inot");

                                       context.read<ReceiverInfoViewModel>().isNepaliBank.value=false;
