...
import '../../modal/getPaymentMethodResponseModal.dart';
            ...
            child: Center(
              ...
              children: [
                ...
                ValueListenableBuilder<PaymentMethodBody?>(
                    ...
                    builder: (_, value, __) {
                      Timer(const Duration(milliseconds: 300),(){
                        Provider.of<ReceiptScreenViewModel>(context,
                            listen: false)
                            .setTotalFee();
                      });

                      return _bankDetailItem(
                          context, 'Payment Gateway', '${value!.charges} AUD');
                    }),
                ...
                ValueListenableBuilder<int>(
                  ...
                  builder: (_, value, __) {
                    return _detailItem(context, 'Amount we\'ll convert',
                        '${int.parse(context.read<PaymentDetailsViewModel>().sendMoneyController.text) } AUD');
                  },
                ),
                SizedBox(height: 10.h),
                ...
                _detailItem(
                    context,
                    'Calculation',
                    '${context.read<PaymentDetailsViewModel>().sendMoneyController.text} AUD x ${context.read<PaymentDetailsViewModel>().getExchageRate()} PKR',
                    Colors.blue),
                SizedBox(height: 15.h),
                _detailItem(
                    context,
                ...
                _detailItem(
                    context,
                    'Should arrive',
                    'by ${context.read<ReceiptScreenViewModel>().selectedPaymentMethod.value!.arrivalTime}',
                    Colors.grey),
    ...
    return ValueListenableBuilder<ReceiverBank?>(
        ...
        builder: (_, value, __) {
          return GestureDetector(
            onTap: () {
              ReceiversBankListBottomSheet bottomSheet =
                  ReceiversBankListBottomSheet(context);
              bottomSheet.show();
            },
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
