...
import '../../../../payment/personal_info/usecase/set_profile_details_usecase.dart';
import '../../../profile/models/get_profile_details_response_model.dart';
import '../../models/countries_province_request_model.dart';
    ...
    var params = SetProfileDetailsRequestModel(
        ...
        attachment: [
          Attachment(
            ...
            // FrontFileName: frontSide == null ? '' : frontSide!,
            // BackFileName: backSide == null ? '' : backSide!,
            isRequired: true,
            isActive: true,
            remarks: ''.toString(),
          ),
          ...
          Attachment(
            ...
            BackFile: ''.toString(),
            BackPath: ''.toString(),
            FrontPath: utilityBill != null ? '' : utilityFilePath,
            FrontFile: utilityBill == null ? '' : utilityBill!,
